...
// `latest` alias moves to a new release. Prioritize Gemini 2.0 Flash for speed, low cost, and accuracy.
const DEFAULT_MODELS = ['gemini-2.0-flash', 'gemini-1.5-flash', 'gemini-2.5-flash', 'gemini-1.5-pro'];
const REQUEST_TIMEOUT_MS = 8_500;
const PIPELINE_TIMEOUT_MS = 14_000;
